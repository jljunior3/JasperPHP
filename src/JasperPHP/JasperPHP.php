...
class JasperPHP
{
    ...
    protected $executable = "\..\JasperStarter\bin\jasperstarter.exe";
    //C:\xampp\htdocs\laravel\vendor\cossou\jasperphp\src\JasperStarter\bin
...
public function process($input_file, $output_file = false, $format = array("pdf"), $parameters = array(), $db_connection = array(), $background = true, $redirect_output = true)
{
    ...
    $db_connection = \Config::get('database.connections.mysql');
